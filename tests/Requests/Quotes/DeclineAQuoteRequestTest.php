...
it('can perform the request', closure: function () {
    $fixturePath = __DIR__.'/../../Fixtures/Saloon/Quotes/decline-a-quote.json';
    ...
    Saloon::fake([
        DeclineAQuoteRequest::class => MockResponse::fixture('Quotes/decline-a-quote'),
    ...
    if (! $existingQuote) {
        $this->markTestSkipped('No quotes found in the system to decline');
    }

    $response = $connector->send(new DeclineAQuoteRequest(quote_id: $existingQuote->id));
