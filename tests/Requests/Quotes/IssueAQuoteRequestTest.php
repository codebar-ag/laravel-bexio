...
it('can perform the request', closure: function () {
    $fixturePath = __DIR__.'/../../Fixtures/Saloon/Quotes/issue-a-quote.json';
    ...
    Saloon::fake([
        IssueAQuoteRequest::class => MockResponse::fixture('Quotes/issue-a-quote'),
    ...
    if (! $existingQuote) {
        $this->markTestSkipped('No quotes found in the system to issue');
    }

    $response = $connector->send(new IssueAQuoteRequest(quote_id: $existingQuote->id));
