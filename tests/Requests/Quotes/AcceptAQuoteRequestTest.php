...
it('can perform the request', closure: function () {
    $fixturePath = __DIR__.'/../../Fixtures/Saloon/Quotes/accept-a-quote.json';
    ...
    Saloon::fake([
        AcceptAQuoteRequest::class => MockResponse::fixture('Quotes/accept-a-quote'),
    ...
    if (! $existingQuote) {
        $this->markTestSkipped('No quotes found in the system to accept');
    }

    $response = $connector->send(new AcceptAQuoteRequest(quote_id: $existingQuote->id));
