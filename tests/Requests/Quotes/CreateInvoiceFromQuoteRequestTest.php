...
it('can perform the request', closure: function () {
    $fixturePath = __DIR__.'/../../Fixtures/Saloon/Quotes/create-invoice-from-quote.json';
    ...
    Saloon::fake([
        CreateInvoiceFromQuoteRequest::class => MockResponse::fixture('Quotes/create-invoice-from-quote'),
    ...
    if (! $existingQuote) {
        $this->markTestSkipped('No quotes found in the system to create invoice from');
    }

    $response = $connector->send(new CreateInvoiceFromQuoteRequest(quote_id: $existingQuote->id));
