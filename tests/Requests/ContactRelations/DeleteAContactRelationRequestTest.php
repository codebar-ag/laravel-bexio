...
it('can perform the request', closure: function () {
    $fixturePath = __DIR__.'/../../Fixtures/Saloon/ContactRelations/delete-a-contact-relation.json';
    $relationFixturePath = __DIR__.'/../../Fixtures/Saloon/ContactRelations/delete-a-contact-relation-create.json';
    $contactFixturePath = __DIR__.'/../../Fixtures/Saloon/ContactRelations/delete-a-contact-relation-contact.json';

    if (shouldResetFixtures()) {
        @unlink($fixturePath);
        @unlink($relationFixturePath);
    ...
    Saloon::fake([
        ...
        CreateContactRelationRequest::class => MockResponse::fixture('ContactRelations/delete-a-contact-relation-create'),
        CreateContactRequest::class => MockResponse::fixture('ContactRelations/delete-a-contact-relation-contact'),
    ...
    $response = $connector->send(new DeleteAContactRelationRequest(id: $relation->id));
