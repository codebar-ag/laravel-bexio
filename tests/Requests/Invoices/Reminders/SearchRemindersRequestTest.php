...
it('can perform the request', closure: function () {
    if (shouldResetFixtures()) {
        @unlink(__DIR__.'/../../../Fixtures/Saloon/Invoices/Reminders/search-reminders.json');
        @unlink(__DIR__.'/../../../Fixtures/Saloon/Invoices/Reminders/create-an-invoice-for-search-reminders.json');
        @unlink(__DIR__.'/../../../Fixtures/Saloon/Invoices/Reminders/issue-an-invoice-for-search-reminders.json');
        @unlink(__DIR__.'/../../../Fixtures/Saloon/Invoices/Reminders/create-a-reminder-for-search.json');
    }

    Saloon::fake([
        CreateAnInvoiceRequest::class => MockResponse::fixture('Invoices/Reminders/create-an-invoice-for-search-reminders'),
        ...
        IssueAnInvoiceRequest::class => MockResponse::fixture('Invoices/Reminders/issue-an-invoice-for-search-reminders'),
        CreateAReminderRequest::class => MockResponse::fixture('Invoices/Reminders/create-a-reminder-for-search'),
        SearchRemindersRequest::class => MockResponse::fixture('Invoices/Reminders/search-reminders'),
    ]);

    $connector = new BexioConnector(new ConnectWithToken);

    $invoiceId = createReminderForSearch($connector);
...
function createReminderForSearch(BexioConnector $connector): ?int
{
