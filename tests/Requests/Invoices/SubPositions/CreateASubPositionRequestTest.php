...
it('can perform the request', closure: function () {
    if (shouldResetFixtures()) {
        @unlink(__DIR__.'/../../../Fixtures/Saloon/Invoices/SubPositions/create-a-sub-position.json');
        @unlink(__DIR__.'/../../../Fixtures/Saloon/Invoices/SubPositions/create-an-invoice-for-sub-position.json');
    }

    Saloon::fake([
        CreateAnInvoiceRequest::class => MockResponse::fixture('Invoices/SubPositions/create-an-invoice-for-sub-position'),
    ...
    if ($invoice === null) {
        $this->markTestSkipped('Unable to create a draft invoice to add a sub-position to.');
    }
