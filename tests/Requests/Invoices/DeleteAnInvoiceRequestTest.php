...
it('can perform the request', closure: function () {
    if (shouldResetFixtures()) {
        @unlink(__DIR__.'/../../Fixtures/Saloon/Invoices/delete-an-invoice.json');
        @unlink(__DIR__.'/../../Fixtures/Saloon/Invoices/create-an-invoice-for-delete.json');
    }
    ...
    Saloon::fake([
        ...
        CreateAnInvoiceRequest::class => MockResponse::fixture('Invoices/create-an-invoice-for-delete'),
    ...
    // Drafts are deletable; issued invoices return 403. So we create a draft and
    // delete it directly without issuing.
    $draft = InvoiceDTO::fromArray([
        'title' => 'Test',
    ...
    $invoice = $connector->send(new CreateAnInvoiceRequest(invoice: $draft))->dto();

    $response = $connector->send(new DeleteAnInvoiceRequest(invoice_id: $invoice->id));
