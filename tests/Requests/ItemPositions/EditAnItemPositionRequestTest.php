...
it('can perform the request', closure: function () {
    ...
    $createFixturePath = __DIR__.'/../../Fixtures/Saloon/ItemPositions/edit-an-item-position-create.json';
    ...
    Saloon::fake([
        ...
        CreateAnItemPositionRequest::class => MockResponse::fixture('ItemPositions/edit-an-item-position-create'),
