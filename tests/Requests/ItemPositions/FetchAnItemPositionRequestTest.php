...
it('can perform the request', closure: function () {
    ...
    $createFixturePath = __DIR__.'/../../Fixtures/Saloon/ItemPositions/fetch-an-item-position-create.json';
    ...
    Saloon::fake([
        ...
        CreateAnItemPositionRequest::class => MockResponse::fixture('ItemPositions/fetch-an-item-position-create'),
    ...
    $response = $connector->send(new FetchAnItemPositionRequest(
        kb_document_type: 'kb_offer',
        document_id: $quote->id,
