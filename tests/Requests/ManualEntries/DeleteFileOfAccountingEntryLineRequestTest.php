...
it('can perform the request', closure: function () {
    Saloon::fake([
        ...
        CreateManualEntryRequest::class => MockResponse::fixture('ManualEntries/create-manual-entry-for-delete-file'),
        AddFileToAccountingEntryLineRequest::class => MockResponse::fixture('ManualEntries/add-file-for-delete-file'),
        FetchFilesOfAccountingEntryRequest::class => MockResponse::fixture('ManualEntries/fetch-files-for-delete-file'),
