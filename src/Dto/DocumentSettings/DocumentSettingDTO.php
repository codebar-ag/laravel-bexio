...
class DocumentSettingDTO extends Data
{
    public function __construct(
        ...
        public ?bool $use_automatic_enumeration,
        public ?bool $use_yearly_enumeration,
        public int $next_nr,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            use_automatic_enumeration: Arr::get($data, 'use_automatic_enumeration'),
            use_yearly_enumeration: Arr::get($data, 'use_yearly_enumeration'),
